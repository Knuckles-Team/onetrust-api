---
name: onetrust-starter
description: >-
  Onetrust API + MCP Server + A2A Server Use when working with Onetrust via this package's MCP
...
license: MIT
tags: [onetrust-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Onetrust Starter Skill

Starter skill for the **Onetrust** package. Use the `mcp-client` universal skill
